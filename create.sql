...
create table blog (id bigint not null, blogurl varchar(255), description varchar(255), feedurl varchar(255), last_update_date datetime2, name varchar(255), published_date datetime2, primary key (id))
